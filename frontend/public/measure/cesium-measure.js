            ...
            drawLineMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    _handlers.setInputAction(function (movement) {
                        ...
                        var cartesian = $this.getCatesian3FromPX(movement.position); // 拾取坐标点
                        if (cartesian && cartesian.x) {
                            if (positions.length == 0) { //若还未取点
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: ($this.getPositionDistance($this.transformCartesianArrayToWGS84Array(positions)) / 1000).toFixed(4) * 1000 + 'm',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: ($this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) / 1000000.0).toFixed(4) * 1000000 + 'm2',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
                            horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
