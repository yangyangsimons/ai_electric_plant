...
import styles from 'css/curve.module.scss';
...
export default function Curve() {
    ...
    useEffect(() => {
        ...
        console.log(document.getElementById('delay-content'));
    ...
    return (
        <div className={styles.averageDelay}>
            <div className={styles.title}>材料腐蚀对比</div>
            <div className={styles.content} id="delay-content"></div>
        </div>
    )
}
