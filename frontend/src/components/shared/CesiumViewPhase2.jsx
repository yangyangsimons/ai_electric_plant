...
const CesiumViewPhase2 = () => {
  ...
  const add3DTiles = (viewer, url, longitude, latitude, height, rotateX=90, rotateY = 90, rotateZ = 0, ) => {
    ...
    add3DTiles(viewer, `${baseUrl}/static/tileset.json`, 115.18509, 22.76196, 3);
  ...
  useEffect(() => {
    ...
    return <div id='container2' ref={viewerRef} style={{ width: '100%', height: '100%', position: 'absolute', left: 0, top: 0 }} />;
};

export default CesiumViewPhase2;
